...
public class HttpAssert {
    ...
    public HttpAssert(Response response, JsonClient jsonClient) {
    ...
    public HttpAssert isHeaderContains(String name, String value) {
        Assert.assertEquals(getResponseHeaders().get(name).toString(), "[" + value + "]", "Headers doesn't match");
        return this;
    }

    public HttpAssert jsonErrorDetailIs(String message) {
    ...
    public HttpAssert jsonErrorDetailContainsText(String text) {
    ...
    public HttpAssert jsonResponseContainsData(Map<String, String> data) {
        JsonNode responseNode = getJsonBody();
    ...
    public HttpAssert jsonResponseContainsData(JsonNode dataNode) {
        JsonNode responseNode = getJsonBody();
    ...
    public HttpAssert jsonResponseContainsFields(Collection<String> listOfFields) {
        JsonNode responseNode = getJsonBody();
    ...
    public HttpAssert responseBodyEqual(String body) {
        Assert.assertEquals(getResponse().getResponseBody(), body);
        return this;
    }

    public HttpAssert jsonResponseContainsDataIntValue(Map<String, Integer> data) {
        JsonNode responseNode = getJsonBody();
    ...
    public HttpAssert jsonResponseDoesntContainsData(Map<String, String> data) {
        JsonNode responseNode = getJsonBody();
    ...
    public HttpAssert responseCodeIs(Integer code) {
    ...
    public HttpAssert jsonResponseContainsDataInCollection(Map<String, String> data) {
    ...
    public HttpAssert jsonResponseDoesntContainsDataInCollection(Map<String, String> data) {
        if (isDataInCollection(data)) {
    ...
    public HttpAssert jsonResponseCollectionContainsTotalValue(Integer total) {
    ...
    public HttpAssert jsonResponseCollectionContainsLimitValue(Integer limit) {
    ...
    public HttpAssert jsonResponseCollectionContainsOffsetValue(Integer offset) {
    ...
    public HttpAssert jsonResponseCollectionContainsHasMoreValue(Boolean hasMore) {
    ...
    public HttpAssert jsonResponseContainsField(String filedName) {
    ...
    public HttpAssert jsonResponseContainsField(String fieldName, String fieldValue) {
    ...
    public HttpAssert jsonResponseDoesntContainField(String filedName) {
        Assert.assertTrue(getJsonBody().get(filedName) == null, "The response contain field: " + filedName);
        return this;
    }

    public HttpAssert jsonResponseContainsFields(String[] fieldsNames) {
    ...
    public HttpAssert jsonResponseDoesntContainFields(String[] fieldsNames) {
        for (String fieldName : fieldsNames) {
    ...
    public HttpAssert jsonResponseContainsFieldsInCollection(String parentIndex, String[] listOfFields) {
        JsonNode responseNode = getJsonBody();
    ...
    private HttpAssert setResponse(Response response) {
        this.response = response;
        return this;
    }

    private HttpAssert setJsonClient(JsonClient jsonClient) {
